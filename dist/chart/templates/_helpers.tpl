...
*/}}
{{- define "vault-k8s-config-operator.name" -}}
...
*/}}
{{- define "vault-k8s-config-operator.fullname" -}}
...
*/}}
{{- define "vault-k8s-config-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "vault-k8s-config-operator.resourceName" -}}
{{- $fullname := include "vault-k8s-config-operator.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "vault-k8s-config-operator.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enable | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "vault-k8s-config-operator.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
